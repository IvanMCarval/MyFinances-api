package com.ivanm.myfinances.api;
...
import com.ivanm.myfinances.service.impl.SecurityUserDetailsService;
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
    ...
    if (authorization != null && authorization.startsWith("Bearer")) {
      ...
      if (isTokenValid) {
        ...
        UsernamePasswordAuthenticationToken user = new UsernamePasswordAuthenticationToken(usuarioAutenticado, null,
